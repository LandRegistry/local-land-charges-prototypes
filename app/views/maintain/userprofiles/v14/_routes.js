...
router.post('/add-user-profiles/localauthority', function(req, res) {

    const localauthorityChoice= req.session.data['localauthority']

    switch (localauthorityChoice) {
        case '1':
            res.redirect('/add-user-profiles/02');
            break;

        case '2':
            res.redirect('/add-user-profiles/10');
            break;

        case '3':
            res.redirect('/add-user-profiles/11');
            break;
